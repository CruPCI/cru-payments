...
cruPayments.creditCard.init(
  'production',
  '00000000000000',
  '00000000000000000000',
);
cruPayments.creditCard.encrypt('4111111111111111', '123', '03', '2020').then(
  tokenObj => {
    console.log({
...
Returns a Promise containing the results of the tokenization. `cruPayments.creditCard.init` must have been called first.
...
Returns a Promise containing the results of the account number encryption. `cruPayments.bankAccount.init` must have been called first.
